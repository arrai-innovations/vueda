...
def make_sure_permissions_exist(apps, schema_editor):
    for app_name in ("vueda_workflow", "workflow_reused_codes"):
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="INSERT INTO auth_group (name) VALUES ('ReusedCodesAdmin');",
            reverse_sql="DELETE FROM auth_group WHERE name = 'ReusedCodesAdmin';",
        ),
    ]
