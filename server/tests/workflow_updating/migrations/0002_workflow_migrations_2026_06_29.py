# Generated by Django 5.2.15 on 2026-06-29 22:17
...
changed_data = [
    {
        "changes": {
            "code": "workflow_updating_workflow",
            "content_type_id": {"app_label": "workflow_updating", "model": "workflowupdating"},
            "historical_app_label": "workflow_updating",
            "historical_model": "workflowupdating",
            "id": {"code": "workflow_updating_workflow"},
            "name": "Workflow Updating Workflow",
        },
        "history_date": datetime.datetime(2026, 6, 29, 22, 0, 31, 801415, tzinfo=datetime.timezone.utc),
        "history_type": "added",
        "model_name": "workflow",
    },
    {
        "changes": {
            "code": "state_a",
            "id": {"code": "state_a", "workflow_id": {"code": "workflow_updating_workflow"}},
            "name": "State A",
            "workflow_id": {"code": "workflow_updating_workflow"},
        },
        "history_date": datetime.datetime(2026, 6, 29, 22, 0, 50, 777052, tzinfo=datetime.timezone.utc),
        "history_type": "added",
        "model_name": "state",
    },
    {
        "changes": {
            "code": "state_b",
            "id": {"code": "state_b", "workflow_id": {"code": "workflow_updating_workflow"}},
            "name": "State B",
            "workflow_id": {"code": "workflow_updating_workflow"},
        },
        "history_date": datetime.datetime(2026, 6, 29, 22, 1, 23, 161110, tzinfo=datetime.timezone.utc),
        "history_type": "added",
        "model_name": "state",
    },
    {
        "changes": {
            "id": {
                "state_id": {"code": "state_a", "workflow_id": {"code": "workflow_updating_workflow"}},
                "workflow_id": {"code": "workflow_updating_workflow"},
            },
            "state_id": {"code": "state_a", "workflow_id": {"code": "workflow_updating_workflow"}},
            "workflow_id": {"code": "workflow_updating_workflow"},
        },
        "history_date": datetime.datetime(2026, 6, 29, 22, 1, 29, 292329, tzinfo=datetime.timezone.utc),
        "history_type": "added",
    ...
    },
    {
        "changes": {
            "code": "a_2_b",
            "id": {"code": "a_2_b", "workflow_id": {"code": "workflow_updating_workflow"}},
            "name": "A 2 B",
            "target_id": {"code": "state_b", "workflow_id": {"code": "workflow_updating_workflow"}},
            "workflow_id": {"code": "workflow_updating_workflow"},
        },
        "history_date": datetime.datetime(2026, 6, 29, 22, 1, 29, 295345, tzinfo=datetime.timezone.utc),
        "history_type": "added",
        "model_name": "transition",
    },
    {
        "changes": {
            "historical_permission_codename": "read_workflowupdating",
            "historical_permission_content_type_app_label": "workflow_updating",
            "historical_permission_content_type_model_name": "workflowupdating",
            "id": {
                "historical_permission_codename": "read_workflowupdating",
                "historical_permission_content_type_app_label": "workflow_updating",
                "historical_permission_content_type_model_name": "workflowupdating",
                "transition_id": {"code": "a_2_b", "workflow_id": {"code": "workflow_updating_workflow"}},
            },
            "permission_id": {
                "codename": "read_workflowupdating",
                "content_type_id": {"app_label": "workflow_updating", "model": "workflowupdating"},
            },
            "transition_id": {"code": "a_2_b", "workflow_id": {"code": "workflow_updating_workflow"}},
        },
        "history_date": datetime.datetime(2026, 6, 29, 22, 16, 6, 277503, tzinfo=datetime.timezone.utc),
        "history_type": "added",
    ...
    },
    {
        "changes": {
            "id": {
                "source_id": {"code": "state_a", "workflow_id": {"code": "workflow_updating_workflow"}},
                "transition_id": {"code": "a_2_b", "workflow_id": {"code": "workflow_updating_workflow"}},
            },
            "source_id": {"code": "state_a", "workflow_id": {"code": "workflow_updating_workflow"}},
            "transition_id": {"code": "a_2_b", "workflow_id": {"code": "workflow_updating_workflow"}},
        },
        "history_date": datetime.datetime(2026, 6, 29, 22, 16, 6, 279989, tzinfo=datetime.timezone.utc),
        "history_type": "added",
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("tests", "0001_initial"),
        ("workflow_updating", "0001_initial"),
    ]
