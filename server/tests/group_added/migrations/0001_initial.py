# Generated by Django 5.2.13 on 2026-04-20 21:56
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(
                        db_collation="case_insensitive_group_added",
                        max_length=254,
                        unique=True,
            ...
            options={
                ...
                "indexes": [
                    django.contrib.postgres.indexes.GinIndex(
                        fields=["email"],
                        name="gin_email_group_added_idx",
                        opclasses=["gin_trgm_ops"],
                    ),
                    django.contrib.postgres.indexes.GinIndex(
                        fields=["name"],
                        name="gin_name_group_added_idx",
                        opclasses=["gin_trgm_ops"],
                    ),
                ],
            },
