...
changed_data = [
    ...
    {
        "changes": {"code": "state_1", "name": "State 1", "workflow_id": {"code": "changed_workflow"}},
        "history_date": datetime.datetime(2024, 5, 14, 21, 22, 54, tzinfo=datetime.timezone.utc),
        "history_type": "added",
        "model_name": "state",
    },
    {
        "changes": {"code": "state_2", "name": "State 2", "workflow_id": {"code": "changed_workflow"}},
        "history_date": datetime.datetime(2024, 5, 14, 21, 22, 55, tzinfo=datetime.timezone.utc),
        "history_type": "added",
        "model_name": "state",
    },
    {
        "changes": {"code": "state_3", "name": "State 3", "workflow_id": {"code": "changed_workflow"}},
    ...
    },
    {
        ...
        "history_date": datetime.datetime(2024, 5, 14, 21, 23, 0, tzinfo=datetime.timezone.utc),
        "history_type": "added",
