...
class TestWorkflowViewSet(BaseTestUserMixin):
    ...
    def groups(self):
        ...
        reader_permissions = Permission.objects.filter(codename__in=["fulfill_orders", "read_workflow", "read_customerorder"])
    ...
    def test_permitted_transitions_returns_403_without_workflow_permissions(
