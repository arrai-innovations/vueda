...
If you create a migration and then upgrade VUEDA, you can run `updategroupmigrations` to update the function implementations embedded in the migration before it is deployed anywhere. Changed data is preserved.
...
If you create a migration and then upgrade VUEDA, you can run `updateworkflowmigrations` to update the function implementations embedded in the migration before it is deployed anywhere. Changed data and other variables are preserved.
