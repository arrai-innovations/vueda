...
This documentation is written for **integrators**: teams integrating VUEDA into a domain application. It assumes working knowledge of:
...
- [**Guides**](/guides/): Task-focused how-to recipes for integrators who already have a running project and need to accomplish a specific thing: split serializers, add workflow transitions, configure list views, integrate VDQ, and more.
