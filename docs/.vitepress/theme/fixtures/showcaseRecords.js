 ...
 * hides what a real model does to a list: a dozen columns that overflow sideways, two
 * ranges and a multi-value choice with no column adapter of their own, and empty values
 * of every type. These rows carry all three on purpose.
 *
