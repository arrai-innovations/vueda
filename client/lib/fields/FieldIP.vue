...
/**
 * Field component for IP address values. Warns in development when the bound value is not a string.
 */
...
useDevTypeGuard(fieldContext, (value) =>
    typeof value !== "string" ? `Expected value to be a string (IP address), got:` : null,
);
</script>
<template>
