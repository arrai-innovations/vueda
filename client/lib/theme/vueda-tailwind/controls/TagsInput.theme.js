    ...
    TagsInput: {
        ...
        root: {
            class: [
                ...
                "aria-invalid:hairline-destructive aria-invalid:has-[input:focus-visible]:hairline-destructive [&[aria-invalid=true]:has(input:focus-visible):not(:has([data-state=active]))]:focus-ring-shadow-destructive",
            ],
        },
    },
});
