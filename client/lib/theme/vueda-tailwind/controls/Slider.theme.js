    ...
    Slider: {
        ...
        thumb: {
            class: [
                ...
                "not-data-[disabled]:hover:ring-4 focus-visible:ring-4 focus-visible:outline-hidden data-[disabled]:pointer-events-none data-[disabled]:bg-disabled-foreground data-[disabled]:border-disabled-foreground data-[disabled]:shadow-none",
            ],
        },
    },
});
