    ...
    Toggle: {
        ...
        root: ({ variant, size }) => ({
            class: [
                ...
                "disabled:!text-disabled-foreground disabled:!bg-transparent disabled:data-[state=on]:!bg-disabled disabled:!hairline-border",
