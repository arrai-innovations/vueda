...
patchTheme({
    ...
    SidebarGroupAction: {
        ...
        root: {
            class: [
                "text-sidebar-foreground hover:bg-sidebar-accent active:bg-sidebar-accent-active hover:text-sidebar-accent-foreground absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-vueda-control p-0 transition-transform focus-visible:focus-ring focus-visible:focus-ring-sidebar [&>svg]:size-4 [&>svg]:shrink-0",
