...
patchTheme({
    ...
    AlertDialogCancel: {
        /**
         * The secondary dismissal button in an alert dialog. It composes the ghost Button recipe (the lowest-weight dismiss treatment, matching every other cancel / back affordance) and adds mobile spacing for stacked footer layouts.
         */
        root: {
