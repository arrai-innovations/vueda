    ...
    DialogScrollContent: {
        ...
        root: {
            class: [
                ...
                "border bg-background p-6 shadow-vueda-overlay duration-200",
        ...
        close: {
            class: [
                ...
                // Shape and interactive states.
                "transition-colors rounded-md hover:bg-accent hover:text-accent-foreground active:bg-accent-active active:text-accent-foreground",
            ],
        },
    },
});
