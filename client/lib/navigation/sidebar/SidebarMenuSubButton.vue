<script setup>
import "@vueda/theme/vueda-tailwind/navigation/SidebarMenuSubButton.theme.js";
...
const theme = useTheme("SidebarMenuSubButton", props, reactive({ size: toRef(props, "size") }));
</script>
