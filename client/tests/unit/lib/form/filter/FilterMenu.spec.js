...
vi.mock("@vueda/form/filter/FilterFieldForm.vue", () => ({ default: FilterFieldFormStub }));
...
beforeEach(async () => {
    FilterMenu = (await import("@vueda/form/filter/FilterMenu.vue")).default;
});
...
describe("lib/form/filter/FilterMenu.vue", () => {
