...
describe("lib/form/field-set/FieldSetStackedInline.vue", () => {
    beforeEach(async () => {
        vi.doMock("@vueda/form/field-set/FieldSetStackedInlineRow.vue", () => ({ default: RowStub }));
        ...
        FieldSetStackedInline = (await import("@vueda/form/field-set/FieldSetStackedInline.vue")).default;
    });
