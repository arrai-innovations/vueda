...
describe("lib/objects-grid/ObjectsGridCardCellSkeleton.vue", () => {
    let ObjectsGridCardCellSkeleton;

    beforeEach(async () => {
        ObjectsGridCardCellSkeleton = (await import("@vueda/objects-grid/ObjectsGridCardCellSkeleton.vue")).default;
