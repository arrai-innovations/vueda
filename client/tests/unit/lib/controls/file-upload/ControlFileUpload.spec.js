...
describe("lib/controls/file-upload/ControlFileUpload.vue", () => {
    describe("rendering", () => {
        scopedIt("renders as a div by default with data-slot", () => {
            const wrapper = mount(ControlFileUpload);
        ...
        scopedIt("renders drop message when dropzone is true", () => {
            const wrapper = mount(ControlFileUpload, { props: { dropzone: true } });
    ...
    describe("file selection", () => {
        ...
        scopedIt("rejects files exceeding maxFileSize", async () => {
            const wrapper = mount(ControlFileUpload, { props: { maxFileSize: 10 } });
            const input = wrapper.find("input[type='file']");
    ...
    describe("drag and drop", () => {
        ...
        scopedIt("ignores drop events when disabled", async () => {
            const wrapper = mount(ControlFileUpload, { props: { dropzone: true, disabled: true } });
            const file = new File(["content"], "dropped.txt", { type: "text/plain" });
