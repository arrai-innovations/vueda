...
describe("lib/controls/textarea/ControlTextarea.vue", () => {
    describe("rendering", () => {
        ...
        scopedIt("merges custom class while preserving base classes", () => {
            const wrapper = mount(ControlTextarea, { props: { class: "my-custom-class" } });
            expect(wrapper.classes()).toContain("my-custom-class");
            expect(wrapper.classes()).toContain("border-input");
        });

        scopedIt("passes through attributes to the textarea", () => {
            const wrapper = mount(ControlTextarea, { attrs: { placeholder: "Enter text", rows: "4" } });
    ...
    describe("v-model", () => {
        scopedIt("reflects modelValue as the textarea value", async () => {
            const wrapper = mount(ControlTextarea, { props: { modelValue: "hello" } });
        ...
        scopedIt("uses defaultValue when modelValue is not provided", () => {
            const wrapper = mount(ControlTextarea, { props: { defaultValue: "default" } });
