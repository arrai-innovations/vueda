...
import ControlInputOTP from "@vueda/controls/input-otp/ControlInputOTP.vue";
import ControlInputOTPGroup from "@vueda/controls/input-otp/ControlInputOTPGroup.vue";
import ControlInputOTPSeparator from "@vueda/controls/input-otp/ControlInputOTPSeparator.vue";
import ControlInputOTPSlot from "@vueda/controls/input-otp/ControlInputOTPSlot.vue";
...
describe("lib/controls/input-otp/ControlInputOTP.vue", () => {
    describe("ControlInputOTP", () => {
        scopedIt("has data-slot=input-otp", () => {
            const wrapper = mount(ControlInputOTP, { props: { maxlength: 6 } });
        ...
        scopedIt("merges custom class into container", () => {
            const wrapper = mount(ControlInputOTP, {
    ...
    describe("ControlInputOTPGroup", () => {
        scopedIt("has data-slot=input-otp-group", () => {
            const wrapper = mount(ControlInputOTPGroup);
        ...
        scopedIt("merges custom class", () => {
            const wrapper = mount(ControlInputOTPGroup, { props: { class: "my-group" } });
    ...
    describe("ControlInputOTPSeparator", () => {
    ...
    describe("ControlInputOTPSlot", () => {
        scopedIt("has data-slot=input-otp-slot", () => {
            const wrapper = mount(ControlInputOTPSlot, { props: { index: 0 } });
        ...
        scopedIt("merges custom class", () => {
            const wrapper = mount(ControlInputOTPSlot, {
        ...
        scopedIt("renders fake caret when hasFakeCaret is true", () => {
            const wrapper = mount(ControlInputOTPSlot, { props: { index: 1 } });
