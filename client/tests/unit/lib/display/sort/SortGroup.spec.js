...
vi.mock("@vueda/display/sort/SortChip.vue", () => ({ default: SortChipStub }));
...
beforeEach(async () => {
    SortGroup = (await import("@vueda/display/sort/SortGroup.vue")).default;
});
...
describe("lib/display/sort/SortGroup.vue", () => {
