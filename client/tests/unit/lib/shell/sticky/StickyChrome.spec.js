...
const importChrome = () => import("@vueda/shell/sticky/StickyChrome.vue");
const importProvider = () => import("@vueda/shell/sticky/StickyStackProvider.vue");

describe("lib/shell/sticky/StickyChrome.vue", () => {
    afterEach(() => {
        vi.clearAllMocks();
    });
