...
import ShellScrollArea from "@vueda/shell/scroll-area/ShellScrollArea.vue";
import ShellScrollBar from "@vueda/shell/scroll-area/ShellScrollBar.vue";
...
describe("lib/shell/scroll-area/ShellScrollArea.vue", () => {
    describe("ShellScrollArea", () => {
        scopedIt("has data-slot=scroll-area on the root", () => {
            const wrapper = mount(ShellScrollArea);
        ...
        scopedIt("merges custom class while preserving base classes", () => {
            const wrapper = mount(ShellScrollArea, { props: { class: "my-class" } });
        ...
        scopedIt("renders a scrollbar via ShellScrollBar", () => {
            const wrapper = mount(ShellScrollArea);
    ...
    describe("ShellScrollBar", () => {
        scopedIt("has data-slot=scroll-area-scrollbar", () => {
            const wrapper = mount(ShellScrollBar);
        ...
        scopedIt("applies horizontal layout classes when orientation is horizontal", () => {
            const wrapper = mount(ShellScrollBar, { props: { orientation: "horizontal" } });
            expect(wrapper.classes()).toContain("h-2.5");
            expect(wrapper.classes()).not.toContain("w-2.5");
        });

        scopedIt("merges custom class", () => {
            const wrapper = mount(ShellScrollBar, { props: { class: "my-scrollbar" } });
