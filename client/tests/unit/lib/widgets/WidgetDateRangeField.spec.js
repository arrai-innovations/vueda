...
vi.mock("@vueda/controls/date-range-field/DateRangeField.vue", () => ({ default: ControlDateRangeFieldStub }));
vi.mock("@vueda/controls/date-range-field/DateRangeFieldInput.vue", () => ({
...
vi.mock("@vueda/controls/range-calendar/RangeCalendar.vue", () => ({ default: ControlRangeCalendarStub }));
...
describe("lib/widgets/WidgetDateRangeField.vue", () => {
    ...
    describe("Rendering", () => {
        scopedIt("renders a DateRangeField element", async () => {
